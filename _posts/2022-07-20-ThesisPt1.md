...
**Example:** For any group $G$, the representation sending $g \mapsto (1)$ for all $g \in G$ is a representation. It is the **trivial representation**.
