...
$$(3\cdot 1 + 2\cdot \sigma) \times (2\cdot 1 - 4\cdot \sigma) = 6\cdot (1\cdot 1) - 12\cdot (1\cdot \sigma) +4\cdot (\sigma\cdot 1) - 8\cdot (\sigma \cdot \sigma)$$ 
$$= -2\cdot 1 - 8 \cdot \sigma.$$
