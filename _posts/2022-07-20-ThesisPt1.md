...
**(Equivalent) ReDefinition:** Let $G$ be a group, $n$ a positive integer, and $k$ a field. A **representation** $\rho$ **over** $k$ is a group homomorphism $$\rho: G \to GL_n(k).$$
